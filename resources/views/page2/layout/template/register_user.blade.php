...
<body>
    <div style="width:722px; border:solid 1px #CCC; font-family:Arial, Helvetica, sans-serif; padding:10px; margin:10px auto; line-height:130%; font-size:14px; color: #333;">
        ...
        <div style="background-repeat:no-repeat; padding-top:20px;">
           ...
           Bạn đã đăng ký tài khoản thành công tại SagittB!!!
            <br />
            <div style=" padding-bottom:10px; padding-top: 10px"><span style=" color:#0d7caa; font-weight:bold;text-decoration:underline;"> Thông tin đăng ký:</span>
            </div>
              <div><u>Email</u>  : {{$contentEmail['user']->email}}</div>
            <div style="margin-bottom:20px;"><u>Số điện thoại</u>  : {{$contentEmail['user']->phone}}</div>
