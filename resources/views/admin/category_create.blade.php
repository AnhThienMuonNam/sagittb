      ...
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <div class="box-footer">
            ...
            <button type="button" class="btn btn-primary pull-right" data-bind="click: $root.saveCategory">Add</button>
            @endif
          </div>
        </div>
      </div>
...
<script src="{{asset('admin_asset/category_create.js')}}"></script>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    options.UploadImage = <?php echo json_encode(url(config('constants.ADMIN_PREFIX') . '/category/uploadImage')); ?>;
    options.CreateCategory = <?php echo json_encode(url(config('constants.ADMIN_PREFIX') . '/category/createPost')); ?>;
