        ...
        <div class="box box-primary">
          ...
          <form role="form" action="create" enctype="multipart/form-data" method="POST">
            ...
            <div class="box-footer">
              ...
              <button type="button" class="btn btn-primary pull-right" data-bind="click: createProduct">Add</button>
              @endif
            </div>
          </form>
        </div>
...
<script src="{{asset('admin_asset/product_create.js')}}"></script>
<script type="text/javascript">
  $(document).ready(function() {
    ...
    options.CreateProduct = <?php echo json_encode(url(config('constants.ADMIN_PREFIX') . '/product/createPost')); ?>;
