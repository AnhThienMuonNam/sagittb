          ...
          <div class="box box-primary">
            ...
            <form role="form" action="create" enctype="multipart/form-data" method="POST">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Hạt*</label>
                    <select class="form-control" data-bind="options: pieces, optionsText: 'name', optionsValue: 'id', value: pieceId, optionsCaption: '-- Chọn loại hạt --'">
                  </select>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Giá tiền VNĐ* (Giá sản phẩm hoặc giá lẻ của loại hạt)</label>
              ...
              <div class="box-footer">
                <button type="button" class="btn btn-primary" data-bind="click: createProduct">Tạo sản phẩm</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
...
<script src="{{asset('admin_asset/admin-product-create.js')}}"></script>
<script type="text/javascript">
  $(document).ready(function() {
     $('.textarea').wysihtml5();
    $('#treeProduct').addClass("active");
     document.getElementById("tabProductCreate").classList.add("active");
    var data = {};
    var options={};
    ...
    options.CreateProduct = <?php echo json_encode(url('/admin/product/createPost')); ?>;
